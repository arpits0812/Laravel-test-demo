    ...
    <div class="container">
        <div class="page-header" style="margin-top: 0">
            <h1>Profile</h1>
                ...
                @if (!empty($users))
                  <form method="post" action="{{ action('ProfileController@UserProfileup') }}" enctype="multipart/form-data">
                    ...
                    @foreach ($users as $user)
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <img src="{{url('/uploads/avatars/users/' . $user->profileImg)}}" alt="Avatar" class="avatar">
